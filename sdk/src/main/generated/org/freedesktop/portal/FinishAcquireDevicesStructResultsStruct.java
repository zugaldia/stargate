 ...
 */
public class FinishAcquireDevicesStructResultsStruct extends Struct {
    @Position(0)
    private final String member0;
    @Position(1)
    private final Map<String, Variant<?>> member1;

    public FinishAcquireDevicesStructResultsStruct(String member0, Map<String, Variant<?>> member1) {
